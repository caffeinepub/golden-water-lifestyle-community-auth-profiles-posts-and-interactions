...
import type { Comment as _Comment, Image as _Image, Post as _Post, Profile as _Profile, ReactionType as _ReactionType, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPost(arg0: string, arg1: Image | null): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updatePost(arg0: bigint, arg1: string, arg2: Image | null): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePost(arg0, arg1, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Comment]): Comment | null {
